...
func (c *headscaleServiceClient) CreateACLPolicy(ctx context.Context, in *CreateACLPolicyRequest, opts ...grpc.CallOption) (*CreateACLPolicyResponse, error) {
	out := new(CreateACLPolicyResponse)
	err := c.cc.Invoke(ctx, "/headscale.v1.HeadscaleService/CreateACLPolicy", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _HeadscaleService_CreateACLPolicy_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(CreateACLPolicyRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(HeadscaleServiceServer).CreateACLPolicy(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/headscale.v1.HeadscaleService/CreateACLPolicy",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(HeadscaleServiceServer).CreateACLPolicy(ctx, req.(*CreateACLPolicyRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var HeadscaleService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _HeadscaleService_CreateACLPolicy_Handler,
		},
	},
